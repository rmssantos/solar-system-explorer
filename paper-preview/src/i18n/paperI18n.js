...
export const PAPER_TRANSLATIONS = Object.freeze({
    pt: Object.freeze({
        ...
        'game.time.open': 'Abrir Observatório do Tempo', 'game.time.close': 'Fechar Observatório do Tempo', 'game.time.kicker': 'Relógio orbital', 'game.time.title': 'Observatório do Tempo', 'game.time.pause': 'Pausa', 'game.time.today': 'Hoje', 'game.time.speedGroup': 'Velocidade do céu',
        'game.time.daysPerSecond': '1 segundo = {days} dias no Sistema Solar', 'game.time.oneDayPerSecond': '1 segundo = 1 dia no Sistema Solar', 'game.time.paused': 'O céu está parado', 'game.time.note': 'Pausa apenas o céu. A tua nave continua pronta.',
        ...
        'game.passport.kicker': 'Passaporte de exploração', 'game.passport.title': 'Diário de bordo', 'game.passport.missions': 'Missões', 'game.passport.investigation': 'Investigação', 'game.passport.collection': 'Coleção', 'game.passport.awards': 'Prémios',
        ...
        'game.expedition.kicker': 'Arquivo secreto da Lumi', 'game.expedition.title': 'O Sinal das Luas', 'game.expedition.copy': 'Segue quatro pistas científicas e descobre o que se esconde sob mundos gelados.', 'game.expedition.evidence': 'Pistas recolhidas', 'game.expedition.art.open': 'Ver a ilustração «{title}» em grande', 'game.expedition.art.enlarge': 'Abrir ilustração',
        'game.expedition.progressAria': 'Progresso das pistas recolhidas', 'game.expedition.routeAria': 'Rota da investigação', 'game.expedition.finale.close': 'Fechar mapa de pistas', 'game.expedition.finale.evidenceAria': 'Pistas científicas',
        'game.mission.assists.aria': 'Ajudas de missão', 'game.mission.assists.title': 'Ajudas · sem perder XP', 'game.mission.assists.guide': '✦ Guia Lumi', 'game.mission.assists.calmPace': '◷ Ritmo calmo', 'game.mission.assists.largeControls': '＋ Controlos XL', 'game.mission.assists.noTimer': 'Sem limite de tempo',
        ...
        'game.contract.locked': 'Por descobrir', 'game.contract.available': 'Nova encomenda', 'game.contract.accepted': 'Em trânsito', 'game.contract.completed': 'Entregue', 'game.contract.travel': 'Viajar até ao destino', 'game.contract.travelling': 'Piloto de papel a caminho…', 'game.contract.complete': 'Encomenda concluída', 'game.contract.iss.unlock': 'Descobre a Terra',
        'game.contract.leave.title': 'Queres guardar esta tentativa?', 'game.contract.leave.copy': 'Podes continuar agora, guardar para mais tarde ou começar de novo.', 'game.contract.leave.continue': 'Continuar missão', 'game.contract.leave.save': 'Guardar e sair', 'game.contract.leave.restart': 'Começar de novo',
        'game.contract.training.title': 'Treino de missão', 'game.contract.training.open': 'Treinar controlos', 'game.contract.training.skip': 'Saltar explicação', 'game.contract.training.next': 'Seguinte',
        'game.contract.art.open': 'Ver o postal «{title}» em grande', 'game.contract.art.enlarge': 'Ver em grande',
    ...
    en: Object.freeze({
        ...
        'game.time.open': 'Open the Time Observatory', 'game.time.close': 'Close the Time Observatory', 'game.time.kicker': 'Orbital clock', 'game.time.title': 'Time Observatory', 'game.time.pause': 'Pause', 'game.time.today': 'Today', 'game.time.speedGroup': 'Sky speed',
        'game.time.daysPerSecond': '1 second = {days} days in the Solar System', 'game.time.oneDayPerSecond': '1 second = 1 day in the Solar System', 'game.time.paused': 'The sky is paused', 'game.time.note': 'Only the sky pauses. Your ship stays ready.',
        ...
        'game.passport.kicker': 'Exploration passport', 'game.passport.title': 'Captain’s log', 'game.passport.missions': 'Missions', 'game.passport.investigation': 'Investigation', 'game.passport.collection': 'Collection', 'game.passport.awards': 'Awards',
        ...
        'game.expedition.kicker': 'Lumi’s secret archive', 'game.expedition.title': 'The Signal of the Moons', 'game.expedition.copy': 'Follow four science clues and discover what hides beneath frozen worlds.', 'game.expedition.evidence': 'Clues collected', 'game.expedition.art.open': 'View the {title} illustration full size', 'game.expedition.art.enlarge': 'Open illustration',
        'game.expedition.progressAria': 'Collected clues progress', 'game.expedition.routeAria': 'Investigation route', 'game.expedition.finale.close': 'Close clue map', 'game.expedition.finale.evidenceAria': 'Scientific clues',
        'game.mission.assists.aria': 'Mission assists', 'game.mission.assists.title': 'Assists · no XP penalty', 'game.mission.assists.guide': '✦ Lumi guide', 'game.mission.assists.calmPace': '◷ Calm pace', 'game.mission.assists.largeControls': '＋ XL controls', 'game.mission.assists.noTimer': 'No time limit',
        ...
        'game.contract.locked': 'Undiscovered', 'game.contract.available': 'New delivery', 'game.contract.accepted': 'In transit', 'game.contract.completed': 'Delivered', 'game.contract.travel': 'Travel to destination', 'game.contract.travelling': 'Paper pilot en route…', 'game.contract.complete': 'Delivery complete', 'game.contract.iss.unlock': 'Discover Earth',
        'game.contract.leave.title': 'Save this attempt?', 'game.contract.leave.copy': 'You can continue now, save it for later, or start again.', 'game.contract.leave.continue': 'Continue mission', 'game.contract.leave.save': 'Save and leave', 'game.contract.leave.restart': 'Start again',
        'game.contract.training.title': 'Mission practice', 'game.contract.training.open': 'Practice controls', 'game.contract.training.skip': 'Skip explanation', 'game.contract.training.next': 'Next',
        'game.contract.art.open': 'View the {title} postcard full size', 'game.contract.art.enlarge': 'View full size',
