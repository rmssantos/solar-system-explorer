...
export const PAPER_TRANSLATIONS = Object.freeze({
    pt: Object.freeze({
        ...
        'game.flight.move': 'Mover', 'game.flight.look': 'Olhar', 'game.flight.up': 'Subir', 'game.flight.down': 'Descer', 'game.flight.brake': 'Travão', 'game.flight.rollLeft': 'Rodar para a esquerda', 'game.flight.rollRight': 'Rodar para a direita', 'game.flight.boostToggle': 'Alternar impulso',
        'game.explore.kicker': 'Ao alcance', 'game.explore': 'Explorar {name}', 'game.controls': 'W/S frente · A/D lateral · rato olha · roda zoom · V cockpit · Shift boost · R/F roda', 'game.touchControls': 'Dois polegares: mover à esquerda · olhar à direita',
        ...
        'game.contract.available': 'Nova encomenda', 'game.contract.accepted': 'Em trânsito', 'game.contract.completed': 'Entregue', 'game.contract.travel': 'Voa até à Terra', 'game.contract.complete': 'Encomenda concluída',
    ...
    en: Object.freeze({
        ...
        'game.flight.move': 'Move', 'game.flight.look': 'Look', 'game.flight.up': 'Climb', 'game.flight.down': 'Descend', 'game.flight.brake': 'Brake', 'game.flight.rollLeft': 'Roll left', 'game.flight.rollRight': 'Roll right', 'game.flight.boostToggle': 'Toggle boost',
        'game.explore.kicker': 'Within reach', 'game.explore': 'Explore {name}', 'game.controls': 'W/S forward · A/D strafe · mouse look · wheel zoom · V cockpit · Shift boost · R/F roll', 'game.touchControls': 'Two thumbs: move on the left · look on the right',
        ...
        'game.contract.available': 'New delivery', 'game.contract.accepted': 'In transit', 'game.contract.completed': 'Delivered', 'game.contract.travel': 'Fly to Earth', 'game.contract.complete': 'Delivery complete',
