...
export const PAPER_TRANSLATIONS = Object.freeze({
    pt: Object.freeze({
        ...
        'game.time.open': 'Abrir Observatório do Tempo', 'game.time.close': 'Fechar Observatório do Tempo', 'game.time.kicker': 'Relógio orbital', 'game.time.title': 'Observatório do Tempo', 'game.time.pause': 'Pausa', 'game.time.speedGroup': 'Velocidade do céu',
    ...
    en: Object.freeze({
        ...
        'game.time.open': 'Open the Time Observatory', 'game.time.close': 'Close the Time Observatory', 'game.time.kicker': 'Orbital clock', 'game.time.title': 'Time Observatory', 'game.time.pause': 'Pause', 'game.time.speedGroup': 'Sky speed',
