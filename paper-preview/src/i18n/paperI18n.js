...
export const PAPER_TRANSLATIONS = Object.freeze({
    pt: Object.freeze({
        ...
        'game.agency.album.open': 'Álbum', 'game.agency.album.kicker': 'Álbum de descobertas', 'game.agency.album.title': 'Tudo o que já encontraste', 'game.agency.mastery.new': 'Nova aventura', 'game.agency.mastery.discovered': 'Descoberto', 'game.agency.mastery.investigator': 'Investigador', 'game.agency.mastery.specialist': 'Especialista', 'game.agency.source.more': 'Para exploradores curiosos: {source}',
    ...
    en: Object.freeze({
        ...
        'game.agency.album.open': 'Album', 'game.agency.album.kicker': 'Discovery album', 'game.agency.album.title': 'Everything you have found', 'game.agency.mastery.new': 'New adventure', 'game.agency.mastery.discovered': 'Discovered', 'game.agency.mastery.investigator': 'Investigator', 'game.agency.mastery.specialist': 'Specialist', 'game.agency.source.more': 'For curious explorers: {source}',
