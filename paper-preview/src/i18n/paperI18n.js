...
export const PAPER_TRANSLATIONS = Object.freeze({
    pt: Object.freeze({
        ...
        'game.agency.science.open': 'Abrir consola', 'game.agency.science.close': 'Fechar consola científica', 'game.agency.science.kicker': 'Ligação direta · sonda', 'game.agency.science.title': 'Consola científica', 'game.agency.science.capture': 'Capturar leitura',
        'game.agency.science.launching': 'Lançamento em curso…', 'game.agency.science.solar.instructions': 'Captura três leituras quando a linha atravessar a assinatura luminosa. Espaço também captura.', 'game.agency.science.neo.instructions': 'Aponta a mira ao objeto com toque, rato ou setas e captura três imagens.', 'game.agency.science.mars.instructions': 'Ajusta a frequência até obteres sinal forte e mantém a ligação durante dois segundos.',
        'game.agency.science.samples': '{count}/3 leituras · qualidade {score}%', 'game.agency.science.tuning': 'Frequência', 'game.agency.science.lock': 'Bloqueio de sinal {value}%', 'game.agency.science.complete': 'Dados científicos enviados · qualidade {score}%', 'game.agency.science.reportScore': 'Desempenho científico {score}%',
        'game.agency.science.feedback.launch': 'A sonda está a caminho. Observa a rota!', 'game.agency.science.feedback.ready': 'Tudo pronto para investigar.', 'game.agency.science.feedback.scan': 'Segue a linha branca até à faixa brilhante.', 'game.agency.science.feedback.find-pulse': 'Quase! Espera que a linha branca entre na faixa brilhante.', 'game.agency.science.feedback.pulse-captured': 'Pulso encontrado! Procura o próximo.', 'game.agency.science.feedback.follow-object': 'Segue o asteroide com a mira.', 'game.agency.science.feedback.hold-focus': 'Mantém a mira sobre o asteroide até o círculo ficar verde.', 'game.agency.science.feedback.focus-ready': 'Focado! Agora tira a fotografia.', 'game.agency.science.feedback.photo-captured': 'Boa fotografia! O asteroide mudou de posição.', 'game.agency.science.feedback.find-signal': 'Move a frequência na direção do sinal mais forte.', 'game.agency.science.feedback.signal-strong': 'Encontraste o sinal. Mantém esta frequência!', 'game.agency.science.feedback.hold-signal': 'Ligação forte! Não deixes a onda escapar.', 'game.agency.science.feedback.complete': 'Investigação terminada. Preparar descoberta!',
    ...
    en: Object.freeze({
        ...
        'game.agency.science.open': 'Open console', 'game.agency.science.close': 'Close science console', 'game.agency.science.kicker': 'Direct link · probe', 'game.agency.science.title': 'Science console', 'game.agency.science.capture': 'Capture reading',
        'game.agency.science.launching': 'Launch in progress…', 'game.agency.science.solar.instructions': 'Capture three readings when the scan line crosses the bright signature. Space also captures.', 'game.agency.science.neo.instructions': 'Aim at the object with touch, mouse or arrow keys and capture three images.', 'game.agency.science.mars.instructions': 'Tune the frequency for a strong signal and hold the link for two seconds.',
        'game.agency.science.samples': '{count}/3 readings · quality {score}%', 'game.agency.science.tuning': 'Frequency', 'game.agency.science.lock': 'Signal lock {value}%', 'game.agency.science.complete': 'Science data sent · quality {score}%', 'game.agency.science.reportScore': 'Science performance {score}%',
        'game.agency.science.feedback.launch': 'The probe is on its way. Watch the route!', 'game.agency.science.feedback.ready': 'Everything is ready to investigate.', 'game.agency.science.feedback.scan': 'Follow the white line towards the bright band.', 'game.agency.science.feedback.find-pulse': 'Almost! Wait for the white line to enter the bright band.', 'game.agency.science.feedback.pulse-captured': 'Pulse found! Look for the next one.', 'game.agency.science.feedback.follow-object': 'Follow the asteroid with the reticle.', 'game.agency.science.feedback.hold-focus': 'Keep the reticle on the asteroid until the circle turns green.', 'game.agency.science.feedback.focus-ready': 'Focused! Now take the photograph.', 'game.agency.science.feedback.photo-captured': 'Good photograph! The asteroid changed position.', 'game.agency.science.feedback.find-signal': 'Move the frequency towards the strongest signal.', 'game.agency.science.feedback.signal-strong': 'You found the signal. Hold this frequency!', 'game.agency.science.feedback.hold-signal': 'Strong link! Do not let the wave escape.', 'game.agency.science.feedback.complete': 'Investigation complete. Preparing discovery!',
