...
export const TRANSLATIONS = {
    pt: {
        ...
        // Manual flight HUD copy
        sun_label: "Sol",
        sun_compass: "SOL",
        rotate_device: "Roda o telemóvel",
        landscape_hint: "Modo horizontal funciona melhor para pilotar.",
        mouse_hint: "Clica + arrasta para olhar | WASD para mover | I = Info",
        pointer_hint: "Segura BOTÃO DIREITO + move rato para olhar",
        speed_light: "Velocidade da Luz! ⚡",
        speed_million: "{n} milhões km/s",
        speed_thousand: "{n} mil km/s",
        comp_universe: "🌟 Nada no universo é mais rápido!",
        comp_earth_mars: "🚀 Terra → Marte em 1 minuto!",
        comp_around_world: "🌍 Volta ao mundo em 0.002 segundos!",
        comp_sun_earth: "☀️ Sol → Terra em 30 segundos!",
        comp_voyager: "🛸 100x mais rápido que a Voyager!",
        comp_lightning: "⚡ 50x mais rápido que um raio!",
        comp_f1: "🏎️ 10.000x mais rápido que um Fórmula 1!",
        comp_plane: "✈️ 5.000x mais rápido que um avião!",
        comp_car: "🚗 Como um carro espacial super veloz!",
        press_w: "Pressiona W para acelerar!",
        mirror_flying_to: "A voar para",
        photo_not_available: "Foto não disponível",
        photo_credit_label: "📷 Imagem: NASA/ESA/Wikimedia Commons",
        moon_gallery_title: "Fotos reais da Lua!",
        to_discover: "Por descobrir",
        install_app: "Instalar aplicação",
        install_app_short: "Instalar app",
        new_version: "🚀 Nova versão disponível",
        update_now: "Atualizar",
        updating: "A atualizar…",
        dismiss: "Dispensar",
        quiz_xp_reason: "Quiz correto",
    ...
    en: {
        ...
        landscape_hint: "Landscape works best for manual flight.",
        mouse_hint: "Click + drag to look around | WASD to move | I = Info",
        pointer_hint: "Hold RIGHT CLICK + move mouse to look around",
        speed_light: "Speed of Light! ⚡",
        speed_million: "{n} million km/s",
        speed_thousand: "{n}k km/s",
        comp_universe: "🌟 Nothing in the universe is faster!",
        comp_earth_mars: "🚀 Earth → Mars in 1 minute!",
        comp_around_world: "🌍 Around the world in 0.002 seconds!",
        comp_sun_earth: "☀️ Sun → Earth in 30 seconds!",
        comp_voyager: "🛸 100x faster than Voyager!",
        comp_lightning: "⚡ 50x faster than lightning!",
        comp_f1: "🏎️ 10,000x faster than an F1 car!",
        comp_plane: "✈️ 5,000x faster than a plane!",
        comp_car: "🚗 Like a super fast space car!",
        press_w: "Press W to accelerate!",
        mirror_flying_to: "Flying to",
        photo_not_available: "Photo not available",
        photo_credit_label: "📷 Image: NASA/ESA/Wikimedia Commons",
        moon_gallery_title: "Real photos from the Moon!",
        to_discover: "To discover",
        install_app: "Install app",
        install_app_short: "Install app",
        new_version: "🚀 New version available",
        update_now: "Update",
        updating: "Updating…",
        dismiss: "Dismiss",
        quiz_xp_reason: "Correct quiz",
