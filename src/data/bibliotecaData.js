...
O Sol é TÃO grande que caberiam mais de 1 MILHÃO de Terras lá dentro! E está a 150 milhões de quilómetros de nós - tão longe que a luz demora 8 minutos a chegar cá!`,
                ...
                comparison: "Se o Sol fosse uma bola de futebol, a Terra seria do tamanho de uma cabeça de alfinete a 25 metros de distância!"
            },
            "mercurio": {
                id: "mercurio",
                name: "Mercúrio",
...
Apesar de estar colado ao Sol, não é o mais quente! Como quase não tem atmosfera (ar), não consegue guardar o calor. De dia é super quente, mas de noite congela!`,
                ...
                comparison: "Mercúrio é pouco maior que a nossa Lua. Se a Terra fosse uma laranja, Mercúrio seria uma uva!"
            },
            "venus": {
                id: "venus",
                name: "Vénus",
...
Tem uma atmosfera super grossa de nuvens tóxicas que funcionam como um cobertor, aprisionando todo o calor.`,
                ...
                comparison: "Vénus e a Terra são quase gémeos de tamanho."
            },
            "terra": {
                id: "terra",
                name: "Terra",
                ...
                comparison: "Se a Terra fosse uma bola de basquete, a Lua seria uma bola de ténis a 7 metros.",
                luas: ["lua"]
            },
            "marte": {
                id: "marte",
                ...
                comparison: "Marte é cerca de metade do tamanho da Terra.",
                luas: ["fobos", "deimos"]
            },
            "jupiter": {
                id: "jupiter",
                ...
                comparison: "Júpiter é 11 vezes maior que a Terra.",
            ...
            "saturno": {
                ...
                comparison: "Saturno é quase tão grande como Júpiter, mas muito mais leve.",
            ...
            "urano": {
                ...
                comparison: "Úrano é 4 vezes maior que a Terra.",
            ...
            "neptuno": {
                ...
                comparison: "Neptuno é irmão gémeo de Úrano.",
                luas: ["tritao"]
            },
            ...
            "plutao": {
                ...
                wowFacts: ["❤️ Tem um glaciar em forma de coração!", "❄️ Neva neve vermelha!", "🏔️ Tem montanhas de gelo de 3.500m!"],
                luas: ["caronte"]
            },
            "ceres": {
                id: "ceres",
                ...
                wowFacts: ["💧 Pode ter mais água doce que a Terra (congelada)!", "💡 Tem 'luzes misteriosas' (manchas de sal brilhante) na superfície."]
            },
            "eris": {
                id: "eris",
                name: "Éris",
                ...
                wowFacts: ["📏 Está 3x mais longe do Sol que Plutão!", "🥶 A atmosfera congela e cai como neve quando se afasta do Sol."]
            },
            "makemake": {
                id: "makemake",
                name: "Makemake",
                ...
                wowFacts: ["🏎️ Um dia dura 22 horas e meia, parecido com a Terra!", "🔴 É avermelhado como Plutão."]
            },
            "haumea": {
                id: "haumea",
                name: "Haumea",
                ...
                wowFacts: ["🌪️ Gira super rápido: um dia dura só 4 horas!", "💍 Tem anéis, o que é raro num objeto tão pequeno!"]
            },

            // === LUAS (Faltava Phobos, Deimos, Luas de Júpiter/Saturno/Urano) ===
            "lua": { id: "lua", name: "Lua", type: "Lua", categoria: "moons", emoji: "🌝", imagem: REAL_PHOTOS.moon, galeria: [
            ...
            ], estatisticas: { raio: "1.737 km" }, wowFacts: ["👣 Pegadas eternas!", "🌊 Cria as marés."] },
            "fobos": { id: "fobos", name: "Fobos", type: "Lua de Marte", categoria: "moons", emoji: "🥔", imagem: REAL_PHOTOS.phobos, descricaoLonga: "Uma das duas luas de Marte. Parece uma batata e está a cair lentamente para Marte!", wowFacts: ["💥 Um dia vai chocar com Marte ou desfazer-se num anel."] },
            "deimos": { id: "deimos", name: "Deimos", type: "Lua de Marte", categoria: "moons", emoji: "🥔", imagem: REAL_PHOTOS.deimos, descricaoLonga: "A outra batata de Marte. É mais pequena e suave que Fobos.", wowFacts: ["👻 O seu nome significa 'Terror' em grego."] },
            // Júpiter
            "io": { id: "io", name: "Io", type: "Lua de Júpiter", categoria: "moons", emoji: "🌋", imagem: REAL_PHOTOS.io, descricaoLonga: "O mundo mais vulcânico de todos! Tem centenas de vulcões ativos a explodir lava.", wowFacts: ["🌋 A superfície renova-se constantemente com a lava.", "👃 Cheira a ovos podres (enxofre)."] },
            "europa": { id: "europa", name: "Europa", type: "Lua de Júpiter", categoria: "moons", emoji: "🧊", imagem: REAL_PHOTOS.europa, descricaoLonga: "A melhor aposta para vida! Tem um oceano gigante de água salgada debaixo do gelo.", wowFacts: ["🌊 Tem 2x mais água que a Terra!", "🦑 Pode haver vida no seu oceano escuro."] },
            "ganimedes": { id: "ganimedes", name: "Ganimedes", type: "Lua de Júpiter", categoria: "moons", emoji: "⚪", imagem: REAL_PHOTOS.ganymede, descricaoLonga: "A maior lua do Sistema Solar! É maior que o planeta Mercúrio.", wowFacts: ["🛡️ É a única lua com campo magnético próprio."] },
            "calisto": { id: "calisto", name: "Calisto", type: "Lua de Júpiter", categoria: "moons", emoji: "🌑", imagem: REAL_PHOTOS.callisto, descricaoLonga: "A bola de golfe cósmica! É o objeto com mais crateras que conhecemos.", wowFacts: ["🤕 A superfície mais antiga e 'bombardeada' do sistema solar."] },
            // Saturno
            "tita": { id: "tita", name: "Titã", type: "Lua de Saturno", categoria: "moons", emoji: "🟡", imagem: REAL_PHOTOS.titan, estatisticas: { raio: "2.574 km" }, wowFacts: ["🌧️ Chove metano!", "✈️ Podias voar com asas nos braços!"] },
            "encelado": { id: "encelado", name: "Encélado", type: "Lua de Saturno", categoria: "moons", emoji: "❄️", imagem: REAL_PHOTOS.enceladus, descricaoLonga: "Uma bola de neve branca e brilhante. Cospe geysers de gelo para o espaço!", wowFacts: ["⛲ Os seus geysers criam um dos anéis de Saturno!", "🌊 Tem oceano subterrâneo."] },
            "mimas": { id: "mimas", name: "Mimas", type: "Lua de Saturno", categoria: "moons", emoji: "💀", imagem: REAL_PHOTOS.mimas, descricaoLonga: "A 'Estrela da Morte'! Tem uma cratera gigante que a faz parecer a estação espacial do Star Wars.", wowFacts: ["🎥 Parece mesmo a Death Star!", "💥 A cratera 'Herschel' quase partiu a lua ao meio."] },
            // Urano/Neptuno/Plutão
            "miranda": { id: "miranda", name: "Miranda", type: "Lua de Úrano", categoria: "moons", emoji: "🧩", descricaoLonga: "A lua Frankenstein! Parece que foi partida e colada de novo de forma errada.", wowFacts: ["🧗 Tem o maior penhasco do sistema solar (20km de altura!)."] },
            "ariel": { id: "ariel", name: "Ariel", type: "Lua de Úrano", categoria: "moons", emoji: "✨", descricaoLonga: "A lua mais brilhante de Úrano! A sua superfície é coberta de gelo fresco e tem vales e desfiladeiros enormes.", wowFacts: ["✨ É a lua mais brilhante de Úrano!", "🏔️ Tem desfiladeiros profundos cheios de gelo!"] },
            "titania": { id: "titania", name: "Titânia", type: "Lua de Úrano", categoria: "moons", emoji: "👑", imagem: REAL_PHOTOS.titania, descricaoLonga: "A maior lua de Úrano! Tem o nome da rainha das fadas de Shakespeare. A sua superfície tem desfiladeiros gigantes maiores que o Grand Canyon.", wowFacts: ["👑 É a MAIOR lua de Úrano!", "🏔️ Tem desfiladeiros maiores que o Grand Canyon da Terra!"] },
            "tritao": { id: "tritao", name: "Tritão", type: "Lua de Neptuno", categoria: "moons", emoji: "🥶", imagem: REAL_PHOTOS.triton, descricaoLonga: "Gira ao contrário! É um mundo capturado por Neptuno. Cospe nitrogénio preto.", wowFacts: ["❄️ É o objeto mais frio medido (-235°C).", "🌋 Tem vulcões de gelo (criovulcões)!"] },
            "caronte": { id: "caronte", name: "Caronte", type: "Lua de Plutão", categoria: "moons", emoji: "👫", imagem: REAL_PHOTOS.charon, descricaoLonga: "É tão grande comparada com Plutão que dançam uma à volta da outra.", wowFacts: ["🔒 Mostra sempre a mesma face a Plutão e vice-versa.", "🏞️ Tem um desfiladeiro 4x mais profundo que o Grand Canyon."] },

            // === SONDAS E OUTROS ===
            "voyager": { id: "voyager", name: "Voyager 1", type: "Sonda", categoria: "probes", emoji: "🛰️", imagem: REAL_PHOTOS.voyager, galeria: [
            ...
            ], descricaoLonga: "O objeto humano mais distante. Saiu do Sistema Solar!", wowFacts: ["💿 Leva música e sons da Terra para aliens.", "📸 Tirou a foto 'Pale Blue Dot'."] },
            "iss": { id: "iss", name: "Estação Espacial", type: "Estação", categoria: "probes", emoji: "🛸", imagem: REAL_PHOTOS.iss, galeria: [
            ...
            ], descricaoLonga: "Casa no espaço para astronautas. É um laboratório gigante que dá a volta à Terra a cada 90 minutos!\n\n⚠️ Nota Triste: A ISS está a ficar velhinha e vai ser 'reformada' (desativada) por volta de 2031. Vai cair no oceano de forma controlada.", wowFacts: ["🌅 16 nasceres do sol por dia!", "💧 Reciclam o chichi para água."] },
            "hubble": { id: "hubble", name: "Hubble", type: "Telescópio", categoria: "probes", emoji: "🔭", imagem: REAL_PHOTOS.hubble, galeria: [
            ...
            ], descricaoLonga: "O olho da Terra no espaço. Viu galáxias super distantes.", wowFacts: ["👓 Podemos ver o passado com ele!", "🌌 Descobriu que o universo está a acelerar."] },
            "curiosity": { id: "curiosity", name: "Curiosity", type: "Rover", categoria: "probes", emoji: "🚙", imagem: REAL_PHOTOS.mars, galeria: [
            ...
            ], descricaoLonga: "Um laboratório com rodas em Marte.", wowFacts: ["🎂 Cantou os Parabéns a si mesmo em Marte!", "🔫 Tem um laser para vaporizar pedras."] },
            "pioneer": { id: "pioneer", name: "Pioneer 10", type: "Sonda", categoria: "probes", emoji: "📡", imagem: REAL_PHOTOS.pioneer, galeria: [
            ...
            ], descricaoLonga: "A primeira sonda a atravessar a cintura de asteroides e a visitar Júpiter. Foi uma verdadeira pioneira!", wowFacts: ["👾 Leva uma placa com desenhos de humanos para aliens.", "⚡ Usa energia nuclear."] }
        }
    },
    // ===== ENGLISH =====
    en: {
...
The Sun is SO big that more than 1 MILLION Earths could fit inside it! And it's 150 million kilometers away from us - so far that light takes 8 minutes to get here!`,
                ...
                comparison: "If the Sun were a soccer ball, Earth would be the size of a pinhead 25 meters away!"
            },
            "mercurio": {
                id: "mercurio",
                name: "Mercury",
...
Even though it's right next to the Sun, it's not the hottest! Since it has almost no atmosphere (air), it can't keep the heat. During the day it's super hot, but at night it freezes!`,
                ...
                comparison: "Mercury is only a little bigger than our Moon. If Earth were an orange, Mercury would be a grape!"
            },
            "venus": {
                id: "venus",
                name: "Venus",
...
It has a super thick atmosphere of toxic clouds that works like a blanket, trapping all the heat.`,
                ...
                comparison: "Venus and Earth are almost twins in size."
            },
            "terra": {
                id: "terra",
                name: "Earth",
                ...
                comparison: "If Earth were a basketball, the Moon would be a tennis ball 7 meters away.",
                luas: ["lua"]
            },
            "marte": {
                id: "marte",
                ...
                comparison: "Mars is about half the size of Earth.",
                luas: ["fobos", "deimos"]
            },
            "jupiter": {
                id: "jupiter",
                ...
                comparison: "Jupiter is 11 times bigger than Earth.",
                luas: ["io", "europa", "ganimedes", "calisto"]
            },
            "saturno": {
                id: "saturno",
                ...
                comparison: "Saturn is almost as big as Jupiter, but much lighter.",
                luas: ["tita", "encelado", "mimas"]
            },
            "urano": {
                id: "urano",
                ...
                comparison: "Uranus is 4 times bigger than Earth.",
                luas: ["miranda", "ariel", "titania"]
            },
            "neptuno": {
                id: "neptuno",
                ...
                comparison: "Neptune is Uranus' twin sibling.",
                luas: ["tritao"]
            },
