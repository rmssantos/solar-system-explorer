...
Tem uma atmosfera super grossa de nuvens tóxicas que funcionam como um cobertor, aprisionando todo o calor.`,
            ...
            "lua": { id: "lua", nome: "Lua", tipo: "Lua", categoria: "moons", emoji: "🌝", imagem: REAL_PHOTOS.moon, galeria: [REAL_PHOTOS.aldrin, REAL_PHOTOS.bootprint, REAL_PHOTOS.rover], estatisticas: { raio: "1.737 km" }, factosUau: ["👣 Pegadas eternas!", "🌊 Cria as marés."] },
            "fobos": { id: "fobos", nome: "Fobos", tipo: "Lua de Marte", categoria: "moons", emoji: "🥔", descricaoLonga: "Uma das duas luas de Marte. Parece uma batata e está a cair lentamente para Marte!", factosUau: ["💥 Um dia vai chocar com Marte ou desfazer-se num anel."] },
            "deimos": { id: "deimos", nome: "Deimos", tipo: "Lua de Marte", categoria: "moons", emoji: "🥔", descricaoLonga: "A outra batata de Marte. É mais pequena e suave que Fobos.", factosUau: ["👻 O seu nome significa 'Terror' em grego."] },
            // Júpiter
            ...
            "mimas": { id: "mimas", nome: "Mimas", tipo: "Lua de Saturno", categoria: "moons", emoji: "💀", descricaoLonga: "A 'Estrela da Morte'! Tem uma cratera gigante que a faz parecer a estação espacial do Star Wars.", factosUau: ["🎥 Parece mesmo a Death Star!", "💥 A cratera 'Herschel' quase partiu a lua ao meio."] },
            ...
            // === SONDAS E OUTROS ===
            "voyager": { id: "voyager", nome: "Voyager 1", tipo: "Sonda", categoria: "probes", emoji: "🛰️", imagem: REAL_PHOTOS.voyager, galeria: [REAL_PHOTOS.voyager_launch, REAL_PHOTOS.pale_blue_dot], descricaoLonga: "O objeto humano mais distante. Saiu do Sistema Solar!", factosUau: ["💿 Leva música e sons da Terra para aliens.", "📸 Tirou a foto 'Pale Blue Dot'."] },
            "iss": { id: "iss", nome: "Estação Espacial", tipo: "Estação", categoria: "probes", emoji: "🛸", imagem: REAL_PHOTOS.iss, galeria: [REAL_PHOTOS.iss_interior, REAL_PHOTOS.iss_2], descricaoLonga: "Casa no espaço para astronautas. É um laboratório gigante que dá a volta à Terra a cada 90 minutos!\n\n⚠️ Nota Triste: A ISS está a ficar velhinha e vai ser 'reformada' (desativada) por volta de 2031. Vai cair no oceano de forma controlada.", factosUau: ["🌅 16 nasceres do sol por dia!", "💧 Reciclam o chichi para água."] },
            "hubble": { id: "hubble", nome: "Hubble", tipo: "Telescópio", categoria: "probes", emoji: "🔭", imagem: REAL_PHOTOS.hubble, galeria: [REAL_PHOTOS.hubble_deploy], descricaoLonga: "O olho da Terra no espaço. Viu galáxias super distantes.", factosUau: ["👓 Podemos ver o passado com ele!", "🌌 Descobriu que o universo está a acelerar."] },
            "curiosity": { id: "curiosity", nome: "Curiosity", tipo: "Rover", categoria: "probes", emoji: "🚙", imagem: REAL_PHOTOS.mars, galeria: [REAL_PHOTOS.curiosity_selfie], descricaoLonga: "Um laboratório com rodas em Marte.", factosUau: ["🎂 Cantou os Parabéns a si mesmo em Marte!", "🔫 Tem um laser para vaporizar pedras."] },
            "pioneer": { id: "pioneer", nome: "Pioneer 10", tipo: "Sonda", categoria: "probes", emoji: "📡", imagem: REAL_PHOTOS.pioneer, galeria: [REAL_PHOTOS.pioneer2], descricaoLonga: "A primeira sonda a atravessar a cintura de asteroides e a visitar Júpiter. Foi uma verdadeira pioneira!", factosUau: ["👾 Leva uma placa com desenhos de humanos para aliens.", "⚡ Usa energia nuclear."] }
        }
    },
    ...
    en: {
        ...
        objects: {
            ...
            // MOONS EN
            "lua": { id: "lua", nome: "Moon", tipo: "Moon", categoria: "moons", emoji: "🌝", imagem: REAL_PHOTOS.moon, galeria: [REAL_PHOTOS.aldrin, REAL_PHOTOS.bootprint, REAL_PHOTOS.rover], factosUau: ["👣 Footprints stay forever.", "🌊 Controls tides."] },
            "fobos": { id: "fobos", nome: "Phobos", tipo: "Mars Moon", categoria: "moons", emoji: "🥔", factosUau: ["💥 Will crash into Mars one day."] },
            "deimos": { id: "deimos", nome: "Deimos", tipo: "Mars Moon", categoria: "moons", emoji: "🥔", factosUau: ["👻 Named 'Terror'."] },
            ...
            "mimas": { id: "mimas", nome: "Mimas", tipo: "Saturn Moon", categoria: "moons", emoji: "💀", factosUau: ["🎥 Looks like the Death Star!"] },
            ...
            // PROBES EN
            "voyager": { id: "voyager", nome: "Voyager 1", tipo: "Probe", categoria: "probes", emoji: "🛰️", imagem: REAL_PHOTOS.voyager, galeria: [REAL_PHOTOS.voyager_launch, REAL_PHOTOS.pale_blue_dot], factosUau: ["💿 Carries Earth sounds for aliens.", "🌌 In interstellar space."] },
            "iss": { id: "iss", nome: "Space Station", tipo: "Station", categoria: "probes", emoji: "🛸", imagem: REAL_PHOTOS.iss, galeria: [REAL_PHOTOS.iss_interior, REAL_PHOTOS.iss_2], factosUau: ["🌅 16 sunrises a day!", "💧 Pee recycled into water."] },
            "hubble": { id: "hubble", nome: "Hubble", tipo: "Telescope", categoria: "probes", emoji: "🔭", imagem: REAL_PHOTOS.hubble, galeria: [REAL_PHOTOS.hubble_deploy], factosUau: ["👓 Showed us the accelerated universe."] },
            "curiosity": { id: "curiosity", nome: "Curiosity", tipo: "Rover", categoria: "probes", emoji: "🚙", imagem: REAL_PHOTOS.mars, galeria: [REAL_PHOTOS.curiosity_selfie], factosUau: ["🎂 Sang Happy Birthday to itself on Mars!"] },
            "pioneer": { id: "pioneer", nome: "Pioneer 10", tipo: "Probe", categoria: "probes", emoji: "📡", imagem: REAL_PHOTOS.pioneer, galeria: [REAL_PHOTOS.pioneer2], factosUau: ["👾 Carries a plaque with drawings of humans.", "⚡ Nuclear powered."] }
        }
    }
};
